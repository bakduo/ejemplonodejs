...
class LoginController {
    ...
    vistalogout = async (req,res,next) =>{
        ...
        const url = "https://fakeproductos.herokuapp.com"+"/login";
    ...
    signup = async (req,res,next)=>{
        if (req.user){
            ...
            const url = "https://fakeproductos.herokuapp.com"+"/productos/vista";
            return res.redirect(url);
        }
    }
    ...
    logout = async(req,res,next) =>{
        ...
        req.session.destroy();
        const url = "https://fakeproductos.herokuapp.com"+"/logout?username="+username;
        return res.redirect(url);
    }
    ...
    login = async (req,res,next) =>{
        ...
        return res.redirect("https://fakeproductos.herokuapp.com"+'/faillogin');
    }
